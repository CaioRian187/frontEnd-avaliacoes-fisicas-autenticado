                    ...
                    <table className="table-auto bg-white w-full rounded-2xl shadow-md">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            <tr className="text-center hover:bg-gray-50">
                                ...
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.altura}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Peso</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.peso}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Ombro</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.ombro}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Cintura</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.cintura}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Quadril</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.quadril}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Peitoral</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.peitoral}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Abdomen</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.abdomen}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Proximal Esquerda</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaProximalEsquerda}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Proximal Direita</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaProximalDireita}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Medial Esquerda</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaMedialEsquerda}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Medial Direita</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaMedialDireita}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Distal Esquerda</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaDistalEsquerda}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Coxa Distal Direita</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.coxaDistalDireita}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Panturrilha Esquerda</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.panturrilhaEsquerda}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Panturrilha Direita</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.panturrilhaDireita}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Braço Relaxado Esquerdo</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.bracoRelaxadoEsquerdo}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Braço Relaxado Direito</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.bracoRelaxadoDireito}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Braço Contraído Esquerdo</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.bracoContraidoEsquerdo}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Braço Contraído Direito</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.bracoContraidoDireito}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Antebraço Esquerdo</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.antebraçoEsquerdo}</td>
                                ))}
                            </tr>
                            <tr className="text-center hover:bg-gray-50">
                                <td className="p-2 text-gray-800">Antebraço Direito</td>
                                {circunferencias.map((circunferencia) => (
                                    <td key={circunferencia.id}>{circunferencia.antebraçoDireito}</td>
                                ))}
                            </tr>
                        </tbody>
                    </table>
